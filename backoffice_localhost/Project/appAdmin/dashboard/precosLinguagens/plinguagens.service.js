...
var PLinguagensService = (function () {
    function PLinguagensService(_http) {
        this._http = _http;
        this._url = 'http://localhost:52143/api/PLinguagens';
    }
    ...
    PLinguagensService.prototype.editarPreco = function (editar) {
        ...
        return this._http.post('http://localhost:52143/api/EditarPreco', body, options).map(function (res) { return res.json(); });
    };
