...
var CriarPrecoComponent = (function () {
    function CriarPrecoComponent(_CriarPrecoService, _router) {
    ...
    CriarPrecoComponent.prototype.todos = function (event) {
        ...
        this._router.navigate(['./precoslinguagens']);
    };
    CriarPrecoComponent = __decorate([
        ...
        __metadata('design:paramtypes', [criarpreco_service_1.CriarPrecoService, router_1.Router])
    ], CriarPrecoComponent);
